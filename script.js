k = `CBj004dWwMeY84ZZ9LK2jUHGBVqV8Rf9`;
...
document.getElementById("about-link").addEventListener("click", function (e) {
    e.preventDefault();
    document.getElementById("fix").scrollIntoView({ behavior: "smooth" });
});
document.getElementById("about-linkk").addEventListener("click", function (e) {
    e.preventDefault();
